...
QT_MOC_LITERAL(18, 275, 24), // "handleCommandReadyToSend"
QT_MOC_LITERAL(19, 300, 27), // "handleFoundMatchingResponse"
QT_MOC_LITERAL(20, 328, 14), // "handleResponse"
QT_MOC_LITERAL(21, 343, 4), // "data"
QT_MOC_LITERAL(22, 348, 24), // "handlePullCommandTimeout"
QT_MOC_LITERAL(23, 373, 29), // "handleSmartMatchingModeChange"
QT_MOC_LITERAL(24, 403, 11), // "isBypassing"
QT_MOC_LITERAL(25, 415, 24) // "handleSendCommandRequest"
...
void QMatchSerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->handleCommandReadyToSend((*reinterpret_cast< const SerialCommand(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMatchSerialPort::sendCommandRequested)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMatchSerialPort::matchingResponseReceived)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMatchSerialPort::messageReceived)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMatchSerialPort::smartMatchingModeChanged)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMatchSerialPort::commandTimedOut)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMatchSerialPort::removeLastCommandSentRequest)) {
                *result = 5;
                return;
            }
        }
        {
            typedef void (QMatchSerialPort::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMatchSerialPort::removeFirstCommandToSendRequest)) {
                *result = 6;
                return;
            }
        }
...
void *QMatchSerialPort::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QMatchSerialPort.stringdata0))
        return static_cast<void*>(const_cast< QMatchSerialPort*>(this));
