...
QT_MOC_LITERAL(1, 14, 20), // "commandIsReadyToSend"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 13), // "SerialCommand"
QT_MOC_LITERAL(4, 50, 7), // "command"
QT_MOC_LITERAL(5, 58, 19), // "commandBufferFilled"
QT_MOC_LITERAL(6, 78, 20), // "responseBufferFilled"
QT_MOC_LITERAL(7, 99, 12), // "writeCommand"
QT_MOC_LITERAL(8, 112, 13), // "writeResponse"
QT_MOC_LITERAL(9, 126, 8) // "response"

    },
    "QSerialBuffer\0commandIsReadyToSend\0\0"
    "SerialCommand\0command\0commandBufferFilled\0"
    "responseBufferFilled\0writeCommand\0"
...
void QSerialBuffer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->writeCommand((*reinterpret_cast< const SerialCommand(*)>(_a[1]))); break;
        ...
        {
            typedef void (QSerialBuffer::*_t)(SerialCommand );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QSerialBuffer::commandIsReadyToSend)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QSerialBuffer::commandBufferFilled)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QSerialBuffer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QSerialBuffer::responseBufferFilled)) {
                *result = 2;
                return;
            }
        }
...
void *QSerialBuffer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QSerialBuffer.stringdata0))
        return static_cast<void*>(const_cast< QSerialBuffer*>(this));
...
// SIGNAL 0
void QSerialBuffer::commandIsReadyToSend(SerialCommand _t1)
{
