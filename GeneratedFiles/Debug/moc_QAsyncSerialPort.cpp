...
QT_MOC_LITERAL(7, 68, 11), // "messageSent"
QT_MOC_LITERAL(8, 80, 7), // "updated"
QT_MOC_LITERAL(9, 88, 7), // "message"
QT_MOC_LITERAL(10, 96, 8), // "openPort"
QT_MOC_LITERAL(11, 105, 9), // "closePort"
QT_MOC_LITERAL(12, 115, 8), // "readData"
QT_MOC_LITERAL(13, 124, 13), // "handleTimeout"
QT_MOC_LITERAL(14, 138, 18), // "handleBytesWritten"
QT_MOC_LITERAL(15, 157, 5), // "bytes"
QT_MOC_LITERAL(16, 163, 11), // "handleError"
QT_MOC_LITERAL(17, 175, 15), // "SerialPortError"
QT_MOC_LITERAL(18, 191, 5) // "error"

    },
    "QAsyncSerialPort\0dataRead\0\0data\0"
    "connectionUpdated\0connected\0failure\0"
    "messageSent\0updated\0message\0openPort\0"
    "closePort\0readData\0handleTimeout\0"
    "handleBytesWritten\0bytes\0handleError\0"
    "SerialPortError\0error"
};
...
void QAsyncSerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAsyncSerialPort::dataRead)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAsyncSerialPort::connectionUpdated)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAsyncSerialPort::messageSent)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QAsyncSerialPort::updated)) {
                *result = 4;
                return;
            }
        }
